...
function addMessage(username, badges, message, isAction, uid, msgId) {
  ...
  const element = $.parseHTML(`
    <div data-sender="${uid}" data-msgid="${msgId}" class=" message-row nes-balloon from-left is-dark {animationIn} animated " id="msg-${totalMessages}">
...
`);
  ...
  if (totalMessages + 1 > messagesLimit) {
    removeRow();
  }
}
